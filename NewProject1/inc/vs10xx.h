...
#include "menu.h"
#define DEFAULT_DIVIDER 0xE000 /* 9.8.4 SCI_CLOCKF (RW) 0xe000 is x5 max intern 61MHz and 10.7.9 */
...
/* register definitions taken from VLSI example code vs10xx_uc.h */
