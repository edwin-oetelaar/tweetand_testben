...
/* Project specific : Edwin added this */                                 
 ...
 * @brief In the following line adjust the value of External High Speed oscillator (HSE)
  ...
  */           
/* project specific : was 25000000 change into 8000000 8MHz external crystal */
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
  ...
  #define HSI_VALUE    ((uint32_t)16000000) /*!< Value of the Internal oscillator in Hz, checked STM32F401RE Edwin */
#endif /* HSI_VALUE */   
