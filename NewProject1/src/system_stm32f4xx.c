...
#define PLL_M      8 /* was 25 OETELAAR */
#define PLL_N      336

/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      4 /* was 2  OETELAAR */

/* USB OTG FS, SDIO and RNG Clock =  PLL_VCO / PLLQ */
#define PLL_Q      4 /* was 7 OETELAAR */
...
uint32_t SystemCoreClock = 84000000; /* OETELAAR */
...
static void SetSysClock(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        FLASH->ACR = FLASH_ACR_PRFTEN | FLASH_ACR_ICEN |FLASH_ACR_DCEN |FLASH_ACR_LATENCY_2WS; /* OETELAAR */
    ...
    else
    {
        ...
        /* OETELAAR , zorgen dat onze interne HSI ook loopt op 84 MHz ipv 16MHz */
        /* Select regulator voltage output Scale 1 mode, System frequency up to 84 MHz */
        RCC->APB1ENR |= RCC_APB1ENR_PWREN;
        PWR->CR |= PWR_CR_VOS;
        ...
        /* Configure the main PLL */
        /* dit is een andere prescaler dan bij de HSE externe kristal versie */
        /* PLL_M is nu 16 niet 8, tevens moeten we de HSI als PLL input schakelen */
        /* */
        RCC->PLLCFGR = /* PLL_M */ 16 | (PLL_N << 6) | (((PLL_P >> 1) -1) << 16) |
                       (RCC_PLLCFGR_PLLSRC_HSI) /* HSI ipv HSE  */ | (PLL_Q << 24);
