...
/* read TX Free Size Register, how many bytes can be pushed to socket without blocking */
...
/* return how many bytes in RECV buffer of the chip for socket sn, we can read this many without blocking */
